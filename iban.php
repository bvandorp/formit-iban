<?php
/*
  FormIt custom validator - IBAN check

  IBAN check as described in:
  ...
  Used as a Formit custom validator
  Usage:

  [[!FormIt?
    &customValidators=`iban`
    &validate=`iban_field:iban`
  ]]
*/

$value; //value given by user
$error = 'Dit is geen geldig IBAN rekeningnummer';
